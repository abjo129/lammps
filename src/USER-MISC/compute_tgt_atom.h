...
ComputeStyle(tgt/atom,ComputeTgtAtom)

#else

#ifndef LMP_COMPUTE_TGT_ATOM_H
#define LMP_COMPUTE_TGT_ATOM_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeTgtAtom : public Compute {
 public:
  ComputeTgtAtom(class LAMMPS *, int, char **);
  ~ComputeTgtAtom();
  void init();
//  void init_list(int, class NeighList *);
 ...
 private:
  ...
  int singleflag;
  double fstr,omega;
  static double *randphase;
  static double *poisson_delt; 
